...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // $sql = "INSERT INTO `overhead` (`tname`, `tdur `, `username`) VALUES ('$taskname', '$time', '$uname');"; 
    $sql =  "INSERT INTO `overhead` (`tname`, `tdur`, `username`) VALUES ('$taskname', '$time', '$uname');";
...
<body>
    ...
    <h6 class="display-6 heading text-center my-4"> Create a overhead Task </h6>

    <div class="container my-4">
        <!-- <form onsubmit="event.preventDefault();"> -->
        <form action="/php/Task-Tune/alter.php" method="POST">

            <div class="mb-3">
                <label for="taskname" class="form-label">Task</label>
                <input type="text" class="i" name="tname">
                <div id="taskname" class="form-text">Enter the new taskname</div>
            </div>

            <div class="mb-3">
                <label for="time" class="form-label">Time</label>
                <input type="text" class="i" form-control" id="time" name="time">
                <div id="timehelp" class="form-text">Enter then expected Duration</div>
            </div>
